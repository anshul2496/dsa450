package c6_online_shopping_service;

import c6_online_shopping_service.enums.ProductCategory;
import c6_online_shopping_service.models.Address;
...
import c6_online_shopping_service.strategy.CreditCardPaymentStrategy;
import c6_online_shopping_service.strategy.UPIPaymentStrategy;
...
public class OnlineShoppingDemo {
	public static void main(String[] args) {
		...
		Product laptop = new Product.Builder("Dell XPS 15", 1499.99).withDescription("A powerful and sleek laptop.")
				.withCategory(ProductCategory.ELECTRONICS).build();
		Product book = new Product.Builder("The Pragmatic Programmer", 45.50)
				.withDescription("A classic book for software developers.").withCategory(ProductCategory.BOOKS).build();
